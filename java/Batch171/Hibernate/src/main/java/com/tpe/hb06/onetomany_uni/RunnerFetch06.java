...
public class RunnerFetch06 {
    public static void main(String[] args) {
        ...
        String hql="SELECT b.id, b.name FROM Student06 s INNER JOIN s.bookList b WHERE s.name='Süleyman'";
        List<Object[]> resultList=session.createQuery(hql).getResultList();resultList.forEach(t-> System.out.println(Arrays.toString(t)));
